...
import { useState, useEffect, useCallback} from 'react'; // Importar useMemo
...
  // Utiliza la instancia única del servicio. Si la clase tuviera dependencias
  // que cambian, usarías useMemo aquí:
  // const faqService = useMemo(() => new FAQService(), []);
  // Pero como no tiene dependencias cambiantes, la instancia global es más simple.
  const faqService = faqServiceInstance; 

  // 1. Corregido: Añadido 'faqService' como dependencia
